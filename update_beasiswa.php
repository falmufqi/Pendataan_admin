...
<title>Update Siswa Beasiswa</title>
    <?php 
    include "koneksi.php";
    ?>
...
<h2 align="center">Form Update Data Siswa Beasiswa</h2>
    <form action="prosesupdate_beasiswa.php" method="post">
    <a href="home.php?page=pagination_beasiswa" class="btn btn-dark mt-2">&larr;Kembali</a>
    ...
    <div class="form-group">
        ...
        <button type="submit" name="submit" class="btn btn-primary mt-2">Submit</button><br>
