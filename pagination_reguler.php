            ...
            <tbody>
                ...
                ?>
                    <tr>
                        ...
                        <td class="no-print">
                            <a href="update_reguler.php?nisn=<?php echo $data['nisn'] ?>" class="btn btn-success no-print">Update</a>
                            <a href="delete_reguler.php?nisn=<?php echo $data['nisn'] ?>" class="btn btn-danger no-print">Delete</a>
                        </td>
                    </tr>
