...
<title>Update Siswa Reguler</title>
    <?php 
    include "koneksi.php";
    ?>
...
<h2 align="center">Form Update Data Siswa Reguler</h2>
    <form action="prosesupdate_reguler.php" method="post">
    <a href="home.php?page=pagination_reguler" class="btn btn-dark mt-2">&larr;Kembali</a>
