...
<body>
            ...
            <tbody>
                ...
                ?>
                    <tr>
                        ...
                        <td class="no-print">
                            <a href="update_beasiswa.php?nisn_bea=<?php echo $data['nisn_bea'] ?>" class="btn btn-success no-print">Update</a>
                            <a href="delete_beasiswa.php?nisn_bea=<?php echo $data['nisn_bea'] ?>" class="btn btn-danger no-print">Delete</a>
                        </td>
                    </tr>
    ...
    <a onclick="PrintDoc()" class="btn btn-warning md-2 no-print">Print Data</a>
