...
if($query){
    echo "<script>alert('Anda Berhasil Update Data');document.location='home.php'</script>";
} else{
    echo "<script>alert('Anda Gagal Update Data');document.location='home.php?page=view_beasiswa'</script>";
}
?>
