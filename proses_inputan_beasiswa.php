...
$pkh_bea=$_POST["pkh_bea"];
  ...
  if ($hasil) {
	echo "<script>alert('Anda Berhasil Input Data Siswa');document.location='home.php'</script>";
}else{
	echo "<script>alert('Anda Gagal Menginput Data');document.location='home.php?page=input_siswa_reguler'</script>";
}
